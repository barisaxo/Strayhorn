...
public class SeventhChordsMenu : IMenu
{
    ...
    public SeventhChordsMenu()
    {
        ...
        Level3 = new("SeventhChord practice: Passing Chord Dominants", () => new PracticeState(() => new SeventhChordPractice3(), () => new MenuState(this)));
        Level4 = new("SeventhChord practice: All SeventhChords", () => new PracticeState(() => new SeventhChordPractice4(), () => new MenuState(this)));
        Selection = Tutorial;
