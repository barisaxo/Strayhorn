...
public class TriadsTutorial : ITutorial
{
    ...
    static TutorialPageDisplay P2 => new(() =>
    {
        ...
        Console.WriteLine("While these are not true 'triads', it's still important to know what they are.");
        ...
        Console.WriteLine("however context can often super impose tonality unto the chords.\n");
        "╔════════════╦══════════════╦═════════════╦═════════════╦══════════╗".WriteLineCentered();
        "║  Tonality  ║ Chord Symbol ║ Intervallic ║ Chord Tones ║   Notes  ║".WriteLineCentered();
        "╠════════════╬══════════════╬═════════════╬═════════════╬══════════╣".WriteLineCentered();
